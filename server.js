...
app.get('/api/cantidad-registros-marca', async (req, res) => {
    try {
      ...
      WHERE CONVERT(datetime, ds.created_at, 120) >= '2024-07-01T00:00:00'
        AND CONVERT(datetime, ds.created_at, 120) <= '2024-07-31T23:59:59.997'
        AND cpp.marca = '${MARCA}';
      `);
      console.log('Resultado de la consulta:', result.recordset[0]);
      res.json(result.recordset[0]);
...
>>>>>>> 2513c1c88fe73278e01eeda87f0c5a40a98e6725
